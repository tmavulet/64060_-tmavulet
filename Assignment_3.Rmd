...
0.09460 are very similar to the 0.1048 the difference between the exact method and the naive-Bayes method is the exact method would need the exact same independent variable classifications to predict, where the naive bayes method does not.
