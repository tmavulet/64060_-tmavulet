Pharmaceuticals <- read.csv("C:/Users/mavul/Downloads/Pharmaceuticals.csv")
View(Pharmaceuticals)

getwd()
setwd("C:/Users/mavul/OneDrive/Documents")
Pharmaceuticaldata<- read.csv("C:/Users/mavul/Downloads/Pharmaceuticals.csv")
...
# Computing and ploing wss for k = 1 to k = 10 and extracting wss for 2-15 clusters
